...
#eggnog-prott5 BP
python3 $WD/Semsim/calculate_semsim.py $WD/Semsim/common_genes_go/longest_eggnog_prott5_go_category/eggnog_longest_depth/${SPECIES}_common_genes_go_eggnog_bp.txt $WD/Semsim/common_genes_go/longest_eggnog_prott5_go_category/gopredsim_prott5_longest_threshold/${SPECIES}_common_genes_go_prott5_bp.txt $WD/Semsim/SemSim/longest_eggnog_prott5_go_category/${SPECIES}_semsim_eggnog_depth_prott5_threshold_bp.txt

#eggnog-prott5 MF
python3 $WD/Semsim/calculate_semsim.py $WD/Semsim/common_genes_go/longest_eggnog_prott5_go_category/eggnog_longest_depth/${SPECIES}_common_genes_go_eggnog_mf.txt $WD/Semsim/common_genes_go/longest_eggnog_prott5_go_category/gopredsim_prott5_longest_threshold/${SPECIES}_common_genes_go_prott5_mf.txt $WD/Semsim/SemSim/longest_eggnog_prott5_go_category/${SPECIES}_semsim_eggnog_depth_prott5_threshold_mf.txt

#eggnog-prott5 CC
python3 $WD/Semsim/calculate_semsim.py $WD/Semsim/common_genes_go/longest_eggnog_prott5_go_category/eggnog_longest_depth/${SPECIES}_common_genes_go_eggnog_cc.txt $WD/Semsim/common_genes_go/longest_eggnog_prott5_go_category/gopredsim_prott5_longest_threshold/${SPECIES}_common_genes_go_prott5_cc.txt $WD/Semsim/SemSim/longest_eggnog_prott5_go_category/${SPECIES}_semsim_eggnog_depth_prott5_threshold_cc.txt
